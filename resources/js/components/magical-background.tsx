...
export default function MagicalBackground() {
    ...
    return (
        <div className="animate-gradient-slow absolute inset-0 overflow-hidden bg-slate-950">
            ...
            {/* Glowing Orb 2 */}
            <div
                className="absolute -right-1/4 -bottom-1/4 h-[80%] w-[80%] rounded-full bg-emerald-600/10 blur-[120px] transition-transform duration-[10000ms] ease-in-out"
                style={{
                    animation:
                        'gradient-flow 20s ease infinite alternate-reverse',
                }}
            />
