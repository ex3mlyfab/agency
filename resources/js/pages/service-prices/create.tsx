...
export default function ServicePriceCreate({ services, serviceCategories }: Props) {
    ...
    return (
        <>
            <Head title="Configure Service Price" />
            <div className="space-y-6 p-6">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Configure a price for a service according to its category.
                    </p>
                </div>
...
ServicePriceCreate.layout = {
    breadcrumbs: [
        { title: 'Service Prices', href: '/service-prices' },
        { title: 'Configure Price', href: '/service-prices/create' },
    ],
};
