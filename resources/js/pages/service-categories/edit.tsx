...
export default function ServiceCategoryEdit({ serviceCategory }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        put(`/service-categories/${serviceCategory.id}`);
    }
...
ServiceCategoryEdit.layout = {
    breadcrumbs: [
        { title: 'Service Categories', href: '/service-categories' },
        { title: 'Edit Category', href: '/service-categories/edit' },
    ],
};
